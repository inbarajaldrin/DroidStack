...
<div style="flex: 1; min-width: 300px;">
  ...
  <img src="../assets/asu-ur5e-rg2-dt-setup.png" alt="Extension Setup" style="width: 100%; border-radius: 6px;" />
</div>
...
## Part 6: Tkinter UI for visualizing

### Code

[https://github.com/inbarajaldrin/vlm_isaac_sim/blob/main/isaac_exts/asu-ur5e-dt/scripts/tkinter_ui.py](https://github.com/inbarajaldrin/vlm_isaac_sim/blob/main/isaac_exts/asu-ur5e-dt/scripts/tkinter_ui.py)
